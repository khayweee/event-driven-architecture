            ...
            <div className='col-3'>
                <div className="card">
                    ...
                    <form className="card-body" onSubmit={e => submit(e, "PICKUP_PRODUCTS")}>
                        <div className='input-group mb-3'>
                            <input type='number' name='purchase_price' className='form-control' placeholder='Purhcase Price'/>
                ...
                <div className="card">
                    ...
                    <form className="card-body" onSubmit={e => submit(e, "DELIVER_PRODUCTS")}>
                        <div className='input-group mb-3'>
                            ...
                            <input type='number' name='quantiity' className='form-control' placeholder='Quantity'/>
                        </div>
                        <button className="btn btn-primary">Submit</button>
                    </form>
                </div>
